...
public class BrittleCommand extends PluginCommand {
	...
	protected void onExecute(long elapsedMilliseconds) {
		if (!CommandUtil.hasPermission(sender, PermissionsType.COMMAND_BRITTLE)) {
			...
			onError().invoke(this, new ExceptionEventArgs<InvalidPermissionsException>(new InvalidPermissionsException(sender, PermissionsType.COMMAND_BRITTLE)));
			return;
		}
	...
	private void eUndo(UUID uuid, Player player) {
		brittleRegistry.removeRegister(uuid);
