...
public class LevitateCommand extends PluginCommand {
	...
	protected void onExecute(long elapsedMilliseconds) {
		if (!CommandUtil.hasPermission(sender, PermissionsType.COMMAND_LEVITATE)) {
			...
			onError().invoke(this, new ExceptionEventArgs<InvalidPermissionsException>(new InvalidPermissionsException(sender, PermissionsType.COMMAND_LEVITATE)));
			return;
		}
	...
	private void e(UUID uuid, Player player) {
		levitateRegistry.setRegister(uuid, null);
	...
	private void eUndo(UUID uuid, Player player) {
		levitateRegistry.removeRegister(uuid);
