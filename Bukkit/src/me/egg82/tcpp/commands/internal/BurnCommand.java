...
public class BurnCommand extends PluginCommand {
	...
	protected void onExecute(long elapsedMilliseconds) {
		if (!CommandUtil.hasPermission(sender, PermissionsType.COMMAND_BURN)) {
			...
			onError().invoke(this, new ExceptionEventArgs<InvalidPermissionsException>(new InvalidPermissionsException(sender, PermissionsType.COMMAND_BURN)));
			return;
		}
	...
	private void eUndo(UUID uuid, Player player) {
		burnRegistry.removeRegister(uuid);
