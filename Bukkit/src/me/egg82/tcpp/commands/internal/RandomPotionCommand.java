...
public class RandomPotionCommand extends PluginCommand {
	...
	protected void onExecute(long elapsedMilliseconds) {
		if (!CommandUtil.hasPermission(sender, PermissionsType.COMMAND_RANDOM_POTION)) {
			sender.sendMessage(LanguageUtil.getString(SpigotLanguageType.INVALID_PERMISSIONS));
			onError().invoke(this, new ExceptionEventArgs<InvalidPermissionsException>(new InvalidPermissionsException(sender, PermissionsType.COMMAND_RANDOM_POTION)));
			return;
		}
	...
	private void e(UUID uuid, Player player) {
		randomPotionRegistry.setRegister(uuid, null);
	...
	private void eUndo(UUID uuid, Player player) {
		randomPotionRegistry.removeRegister(uuid);
