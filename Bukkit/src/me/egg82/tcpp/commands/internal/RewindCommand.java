...
public class RewindCommand extends PluginCommand {
	...
	protected void onExecute(long elapsedMilliseconds) {
		if (!CommandUtil.hasPermission(sender, PermissionsType.COMMAND_REWIND)) {
			...
			onError().invoke(this, new ExceptionEventArgs<InvalidPermissionsException>(new InvalidPermissionsException(sender, PermissionsType.COMMAND_REWIND)));
			return;
		}
	...
	private void eUndo(UUID uuid, Player player) {
		rewindRegistry.removeRegister(uuid);
