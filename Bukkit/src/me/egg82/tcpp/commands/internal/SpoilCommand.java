...
public class SpoilCommand extends PluginCommand {
	...
	protected void onExecute(long elapsedMilliseconds) {
		if (!CommandUtil.hasPermission(sender, PermissionsType.COMMAND_SPOIL)) {
			sender.sendMessage(LanguageUtil.getString(SpigotLanguageType.INVALID_PERMISSIONS));
			onError().invoke(this, new ExceptionEventArgs<InvalidPermissionsException>(new InvalidPermissionsException(sender, PermissionsType.COMMAND_SPOIL)));
			return;
		}
	...
	private void e(UUID uuid, Player player) {
		spoilRegistry.setRegister(uuid, null);
	...
	private void eUndo(UUID uuid, Player player) {
		spoilRegistry.removeRegister(uuid);
