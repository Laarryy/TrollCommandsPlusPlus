...
public class LavaBuildCommand extends PluginCommand {
	...
	protected void onExecute(long elapsedMilliseconds) {
		if (!CommandUtil.hasPermission(sender, PermissionsType.COMMAND_LAVA_BUILD)) {
			sender.sendMessage(LanguageUtil.getString(SpigotLanguageType.INVALID_PERMISSIONS));
			onError().invoke(this, new ExceptionEventArgs<InvalidPermissionsException>(new InvalidPermissionsException(sender, PermissionsType.COMMAND_LAVA_BUILD)));
			return;
		}
	...
	private void e(UUID uuid, Player player) {
		lavaBuildRegistry.setRegister(uuid, null);
		metricsHelper.commandWasRun(this);
		
		sender.sendMessage("The next block " + player.getName() + " places will now be lava!");
	}
	...
	private void eUndo(UUID uuid, Player player) {
		...
		sender.sendMessage("The next block " + player.getName() + " places will no longer be lava.");
	}
