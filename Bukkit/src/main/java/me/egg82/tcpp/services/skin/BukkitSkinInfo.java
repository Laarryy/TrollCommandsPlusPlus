...
public class BukkitSkinInfo implements SkinInfo {
    ...
    public BukkitSkinInfo(UUID uuid, File cacheDir) throws IOException {
        this.uuid = uuid;
    ...
    public BukkitSkinInfo(UUID uuid, String name, Skin skin) {
        this.uuid = uuid;
        this.name = name;
        this.skin = skin;
    }
