...
public class GarbleTroll extends BukkitTroll {
    private static final Set<UUID> garbles = new HashSet<>();

    public GarbleTroll(UUID playerID, TrollType type) {
        super(playerID, type);
    }
