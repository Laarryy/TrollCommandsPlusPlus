...
public class MoistCommand extends PluginCommand {
	//vars
	...
	//constructor
	public MoistCommand(CommandSender sender, Command command, String label, String[] args) {
	...
	protected void onExecute(long elapsedMilliseconds) {
		if (!CommandUtil.hasPermission(sender, PermissionsType.COMMAND_MOIST)) {
			sender.sendMessage(LanguageUtil.getString(SpigotLanguageType.INVALID_PERMISSIONS));
			onError().invoke(this, new ExceptionEventArgs<InvalidPermissionsException>(new InvalidPermissionsException(sender, PermissionsType.COMMAND_MOIST)));
			return;
		}
