...
public class ElectrifyCommand extends PluginCommand {
	...
	protected void onExecute(long elapsedMilliseconds) {
		if (!CommandUtil.hasPermission(sender, PermissionsType.COMMAND_ELECTRIFY)) {
			...
			onError().invoke(this, new ExceptionEventArgs<InvalidPermissionsException>(new InvalidPermissionsException(sender, PermissionsType.COMMAND_ELECTRIFY)));
			return;
		}
	...
	private void eUndo(UUID uuid, Player player) {
		electrifyRegistry.removeRegister(uuid);
