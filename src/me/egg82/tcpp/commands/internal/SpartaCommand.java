...
public class SpartaCommand extends PluginCommand {
	//vars
	...
	//constructor
	public SpartaCommand(CommandSender sender, Command command, String label, String[] args) {
	...
	protected void onExecute(long elapsedMilliseconds) {
		if (!CommandUtil.hasPermission(sender, PermissionsType.COMMAND_SPARTA)) {
			sender.sendMessage(LanguageUtil.getString(SpigotLanguageType.INVALID_PERMISSIONS));
			onError().invoke(this, new ExceptionEventArgs<InvalidPermissionsException>(new InvalidPermissionsException(sender, PermissionsType.COMMAND_SPARTA)));
			return;
		}
	...
	private void eUndo(UUID uuid, Player player) {
		spartaRegistry.removeRegister(uuid);
