...
public class RandomDropCommand extends PluginCommand {
	...
	protected void onExecute(long elapsedMilliseconds) {
		if (!CommandUtil.hasPermission(sender, PermissionsType.COMMAND_RANDOM_DROP)) {
			...
			onError().invoke(this, new ExceptionEventArgs<InvalidPermissionsException>(new InvalidPermissionsException(sender, PermissionsType.COMMAND_RANDOM_DROP)));
			return;
		}
	...
	private void e(UUID uuid, Player player) {
		randomDropRegistry.setRegister(uuid, null);
		metricsHelper.commandWasRun(this);
		
		sender.sendMessage("Any item " + player.getName() + " drops will now turn into a random item!");
	}
	...
	private void eUndo(UUID uuid, Player player) {
		randomDropRegistry.removeRegister(uuid);
