...
public class VomitCommand extends PluginCommand {
	...
	protected void onExecute(long elapsedMilliseconds) {
		if (!CommandUtil.hasPermission(sender, PermissionsType.COMMAND_VOMIT)) {
			sender.sendMessage(LanguageUtil.getString(SpigotLanguageType.INVALID_PERMISSIONS));
			onError().invoke(this, new ExceptionEventArgs<InvalidPermissionsException>(new InvalidPermissionsException(sender, PermissionsType.COMMAND_VOMIT)));
			return;
		}
	...
	private void e(UUID uuid, Player player) {
		vomitRegistry.setRegister(uuid, null);
	...
	private void eUndo(UUID uuid, Player player) {
		vomitRegistry.removeRegister(uuid);
