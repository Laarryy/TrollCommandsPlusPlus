...
public class LockCommand extends PluginCommand {
	...
	protected void onExecute(long elapsedMilliseconds) {
		if (!CommandUtil.hasPermission(sender, PermissionsType.COMMAND_LOCK)) {
			...
			onError().invoke(this, new ExceptionEventArgs<InvalidPermissionsException>(new InvalidPermissionsException(sender, PermissionsType.COMMAND_LOCK)));
			return;
		}
	...
	private void e(UUID uuid, Player player) {
		lockRegistry.setRegister(uuid, null);
	...
	private void eUndo(UUID uuid, Player player) {
		lockRegistry.removeRegister(uuid);
